...
use \ArrayAccess;
/**
 * MemberLocationResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MemberLocationResponse implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'returned' => 'int',
        'message' => 'string',
        'results' => '\Swagger\Client\Model\MemberLocation[]'
    );
    ...
    /**
     * Sets results
     * @param \Swagger\Client\Model\MemberLocation[] $results 
     * @return $this
     */
